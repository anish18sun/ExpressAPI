...
class ColorDescriptor:
	...
	def describe(self, image):
		...
		# divide the image into four separate regions(top-left, top-right,
		...
		for(startX, endX, startY, endY) in segments: 
			...
			# subtracting the center from it
	...
	def histogram(self, image, mask):
		...
		# using the supplied number of bins per channel, then normalize the histogram
